...
shared_examples_for Sluggable do
  context 'after creating' do
    it { expect(subject.slug).to eql "#{subject.id}-desenvolvedor-back-end-java-on-rails-pleno" }
  end
...
describe Job do
  it_behaves_like Sluggable do
    subject { create(:job, title: 'desenvolvedor back-end java on rails pleno') }
  end
end
